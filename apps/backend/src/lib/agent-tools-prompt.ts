...
export function formatAgentToolsPrompt(
  ...
  if (names.has('get_available_slots')) {
    rules.push(
      ...
      'Якщо в попередній відповіді ти вже назвав конкретні години з get_available_slots і клієнт обрав одну з них — не роби новий get_available_slots і не кажи що вікон немає, доки book_appointment не повернув помилку або клієнт не змінив послуги/дату/майстрів.',
