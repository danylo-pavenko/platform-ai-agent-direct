...
export function formatAgentToolsPrompt(
  ...
  if (names.has('book_appointment')) {
    rules.push(
      ...
      'Заборонено писати клієнту «записала / записав / записали вас / чекаємо тебе / бачимось о HH:MM / запис підтверджено / одразу закріплю» без успішного book_appointment у ТІЙ САМІЙ відповіді. Додати брови/ще послугу до вже «записаного» візиту — знову get_available_slots (усі майстри) + book_appointment; не стверджуй оновлення без tool.',
