...
- Запропоновані години з get_available_slots платформа зберігає в розмові (~2 год) і підставляє як «Запропоновані вікна». Якщо клієнт обрав одну з них — book_appointment без нового lookup. Новий get_available_slots лише коли змінили послугу/дату/майстра або book повернув SLOT_NOT_AVAILABLE / TIME_CONFLICT / MASTER_DAY_CLOSED. Пауза на ПІБ/телефон не вимагає свіжих слотів.
