...
- BeautyPro і CleverBOX: book_appointment потребує повний service_id / master_id з «Запропоновані вікна» (UUID або число). Обрізаний префікс чи імʼя платформа розгортає з оферу/каталогу, якщо унікально; інакше INVALID_CRM_ID, без POST.
