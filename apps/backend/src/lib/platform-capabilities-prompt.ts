...
- Два майстри з однаковим імʼям — у слотах підпис з positions / повний [master_id=UUID]; у tools завжди повний UUID з «Запропоновані вікна» або останнього get_available_slots, не імʼя і не перші 8 символів.
...
- BeautyPro service/master id має бути повним GUID. Обрізаний префікс (напр. 88d8645d) платформа намагається розгорнути з оферу/каталогу; якщо не унікально — INVALID_CRM_ID, без POST.
