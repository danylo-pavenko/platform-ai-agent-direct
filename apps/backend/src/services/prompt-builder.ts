...
ФОРМАТ ВІДПОВІДІ: пиши ТІЛЬКИ текст для клієнта в Direct (мовою діалогу).
НЕ пиши внутрішні міркування англійською ("not a coding task", "I should respond…",
"This is an Instagram DM…") — ні перед відповіддю, ні окремим абзацом.`;
